...
void MainWindow::initAVISClient()
...
void MainWindow::on_ajouter_clicked()
{
    ...
    if(e.verif_EMAIL(e.get_EMAIL())==false){
        ...
        if(test)
        {
            QFile file("C:\\Users\\Lenovo\\Desktop\\Crud_Vfmarwa\\Crud_Vfmarwa\\Historique\\HistoriqueClient.txt");
            ...
            ui->tabetudiant->setModel(tmpCLIENT.afficher_Clist());
            ui->listeclient->setModel(tmpCLIENT.afficher_Clist());//refreche combobox choix +refreche tableaux
            sa.ajouterclient(ui->lineEdit_NOM->text());
            initClient();
...
{
    QFile file ("C:\\Users\\Lenovo\\Desktop\\Crud_Vfmarwa\\Crud_Vfmarwa\\Historique\\HistoriqueClient.txt");//tbadel i chemin
...
void MainWindow::on_pushButton_5_clicked()
{
    ...
    QSqlQuery query ;
    query=tmpCLIENT.tableclicked(val);
...
void MainWindow::on_pb_ajouter_5_clicked()
{
    ...
    /*if(e.verif_CIN(e.get_ID_AVIS())==false){
        ...
        {ui->tabetudiant_2->setModel(tmpAVIS_CLIENT.afficher());//refresh
            sa.ajouteravisclient( ui->lineEdit_AVIS_client_2->text());
